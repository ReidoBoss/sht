file://<WORKSPACE>/api/app/model/domain/Habit.scala
### java.lang.StringIndexOutOfBoundsException: Range [979, 989) out of bounds for length 988
...
action parameters:
offset: 983
uri: file://<WORKSPACE>/api/app/model/domain/Habit.scala
text:
```scala
