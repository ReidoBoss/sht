file://<WORKSPACE>/api/app/utils/results.scala
...
action parameters:
offset: 384
uri: file://<WORKSPACE>/api/app/utils/results.scala
text:
```scala
...
def HABIT_RETRIEVE(json:@@) = makeResult( Ok, _ )
