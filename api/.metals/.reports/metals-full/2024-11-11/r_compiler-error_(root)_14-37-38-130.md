file://<WORKSPACE>/app/controllers/HabitController.scala
...
action parameters:
offset: 221
uri: file://<WORKSPACE>/app/controllers/HabitController.scala
text:
```scala
package controllers
...
class HabitController @Inject()(
  ...
  def updateById = Action(parse.json).async { implicit request =>
    ...
    .fold(
      error => HABIT_BAD_REQUEST(error.errorsAsJson),
      id => updateTodaysHabitById(id)
    )
    // habitServices.updateTodaysHabitById
  }
